...
static const PsxrecompCodegenHostConfig kCodegenConfig = {
    .display_name = "R-Type Delta",
    .project_root_env = "R_TYPE_DELTA_PROJECT_ROOT",
    .build_dir_env = "R_TYPE_DELTA_BUILD_DIR",
    .force_setup_env = "R_TYPE_DELTA_FORCE_SETUP",
    .psxrecomp_cli_relpath = "psxrecomp/psxrecomp_cli.py",
    .seed_cfg_relpath = "game.toml",
    .game_toml_relpath = "game.toml",
    .gen_marker_relpath = "generated/SLUS_008.77_dispatch.c",
    .build_dir_name = "build-release",
    .cmake_target = "psx-runtime",
    .exe_basename = "R_Type_Delta_Recompiled",
    .prepare_note =
